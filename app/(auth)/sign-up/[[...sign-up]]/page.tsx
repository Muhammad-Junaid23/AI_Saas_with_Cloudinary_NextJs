            ...
            <div className='space-y-3 xl:space-y-4'>
              <div className='flex items-center gap-3 xl:gap-4 p-3 xl:p-4 bg-white/5 rounded-xl backdrop-blur-sm border border-white/10'>
                ...
                <div className='min-w-0'>
                  <h3 className='text-white font-semibold text-sm xl:text-base'>Lightning Fast</h3>
                  <p className='text-gray-400 text-xs xl:text-sm'>Upload and process in seconds</p>
                </div>
              </div>
              ...
              <div className='flex items-center gap-3 xl:gap-4 p-3 xl:p-4 bg-white/5 rounded-xl backdrop-blur-sm border border-white/10'>
                ...
                <div className='min-w-0'>
                  <h3 className='text-white font-semibold text-sm xl:text-base'>AI Enhancement</h3>
                  <p className='text-gray-400 text-xs xl:text-sm'>Smart optimization and effects</p>
                </div>
              </div>
              ...
              <div className='flex items-center gap-3 xl:gap-4 p-3 xl:p-4 bg-white/5 rounded-xl backdrop-blur-sm border border-white/10'>
                ...
                <div className='min-w-0'>
                  <h3 className='text-white font-semibold text-sm xl:text-base'>100% Secure</h3>
                  <p className='text-gray-400 text-xs xl:text-sm'>Your data is always protected</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className='w-full max-w-md'>
              <div className='lg:hidden text-center mb-6 sm:mb-8'>
                ...
                <div className='space-y-2'>
                  ...
                  <p className='text-gray-400 text-sm sm:text-base'>Join us and start managing your media</p>
                </div>
              </div>
              ...
              <div className='relative'>
                ...
                <div className='relative p-4 sm:p-6 lg:p-8'>
                  <div className='hidden lg:block text-center mb-6'>
                    <h2 className='text-xl xl:text-2xl font-bold text-white mb-2'>Create Account</h2>
                    <p className='text-gray-400 text-sm xl:text-base'>Join us and start managing your media</p>
                  </div>
                  ...
                  <SignUp
                    appearance={{
                      elements: {
                        ...
                        verificationLinkStatusText: 'text-gray-400 text-sm',
                        verificationLinkStatusIconBox: 'text-blue-400',
                      },
                      layout: {
