    ...
    <div className='space-y-8'>
      ...
      <div className='text-center'>
        <div className='flex items-center justify-center gap-3 mb-4'>
          ...
          <h1 className='text-4xl font-bold text-white'>Video Upload</h1>
        </div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
        <div className='stats shadow-xl bg-gradient-to-r from-blue-500/20 to-purple-600/20 backdrop-blur-sm border border-white/10'>
          <div className='stat'>
            ...
            <div className='stat-title text-gray-300'>Max File Size</div>
            <div className='stat-value text-white'>70MB</div>
            <div className='stat-desc text-gray-400'>Per upload</div>
          </div>
        </div>
        ...
        <div className='stats shadow-xl bg-gradient-to-r from-green-500/20 to-emerald-600/20 backdrop-blur-sm border border-white/10'>
          <div className='stat'>
            ...
            <div className='stat-title text-gray-300'>Processing</div>
            <div className='stat-value text-white'>AI</div>
            <div className='stat-desc text-gray-400'>Powered optimization</div>
          </div>
        </div>
        ...
        <div className='stats shadow-xl bg-gradient-to-r from-purple-500/20 to-pink-600/20 backdrop-blur-sm border border-white/10'>
          <div className='stat'>
            ...
            <div className='stat-title text-gray-300'>Formats</div>
            <div className='stat-value text-white'>All</div>
            <div className='stat-desc text-gray-400'>Video types supported</div>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className='space-y-8'>
          ...
          <div className='card bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-white/10 shadow-2xl'>
            <div className='card-body'>
              <div className='flex items-center gap-3 mb-6'>
                ...
                <h2 className='card-title text-white'>Video Details</h2>
              </div>
              ...
              <div className='space-y-6'>
                <div className='form-control'>
                  <label className='label'>
                    ...
                    <span className='label-text-alt text-gray-500'>{title.length}/100</span>
                  </label>
                  <input
                    type='text'
                    value={title}
                    onChange={(e) => setTitle(e.target.value)}
                    className='input input-bordered w-full bg-white/10 border-white/20 text-white placeholder-gray-400 focus:border-blue-500'
                ...
                <div className='form-control'>
                  <label className='label'>
                    ...
                    <span className='label-text-alt text-gray-500'>{description.length}/500</span>
                  </label>
                  <textarea
                    value={description}
                    onChange={(e) => setDescription(e.target.value)}
                    className='textarea textarea-bordered w-full h-32 bg-white/10 border-white/20 text-white placeholder-gray-400 focus:border-blue-500 resize-none'
          ...
          <div className='card bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-white/10 shadow-2xl'>
            <div className='card-body'>
              <div className='flex items-center gap-3 mb-6'>
                ...
                <h2 className='card-title text-white'>Upload Video</h2>
              </div>
                ...
                {file ? (
                  <div className='space-y-4'>
                    ...
                    <div>
                      ...
                      <div className='mt-2'>
                        <div className={`badge ${file.size > MAX_FILE_SIZE ? 'badge-error' : 'badge-success'}`}>
                  ...
                  <div className='space-y-4'>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className='file-input file-input-bordered file-input-primary w-full max-w-xs bg-white/10 border-white/20'
                        required
                      />
                    </div>
                  </div>
        ...
        <div className='flex justify-center'>
          <button
            type='submit'
            className='btn btn-primary btn-lg bg-gradient-to-r from-blue-500 to-purple-600 border-none text-white hover:scale-105 transition-transform disabled:opacity-50 disabled:cursor-not-allowed'
